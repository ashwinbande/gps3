# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-25 12:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Ai', models.CharField(blank=True, max_length=1024, null=True)),
                ('Ei', models.CharField(blank=True, max_length=1024, null=True)),
                ('Xi', models.CharField(blank=True, max_length=1024, null=True)),
                ('sign_created', models.BooleanField(default=False)),
